...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
	QnaDTO dto = (QnaDTO) request.getAttribute("qnaAnswer");
...
<body>
	...
	<%@ include file="../include/mypageSidebar.jsp" %>
	 ...
	 <div class="col-md-10">
		...
		<h3><%=dto.getsId()%>님의 문의 글에 대한 답변
		</h3>
		<hr width="65%" color="#E4F7BA" />
		<form method="post" action="qna_answer_ok.do?no=<%=dto.getqNum()%>&page=<%=nowPage%>">
			<table width="800">
				<tr>
				...
				<tr>
					...
					<td><textarea rows="1" cols="80" name="qtitle"
							readonly="readonly"><%=dto.getqTitle()%>
					</textarea></td>
				</tr>
				<tr>
					<th align="center">문의</th>
					<td><textarea rows="15" cols="80" name="qcont"
							readonly="readonly"><%=dto.getqCont()%>
					</textarea></td>
				</tr>
				<tr>
					<th align="center">답변 작성</th>
					<td><textarea rows="15" cols="80" name="acont"><%=dto.getaCont()%>
					</textarea></td>
				</tr>
			</table>
